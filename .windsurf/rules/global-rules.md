...
You are NOT allowed to delete, remove, or replace any existing function, method, class, or exported interface unless you have explicit, authorization from the user.
